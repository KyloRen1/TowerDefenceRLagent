...
def create_game_window(
        cfg: EasyDict) -> Tuple[pg.Surface, pg.time.Clock, pg.Surface]:
  ...
  """
    ...
    screen = pg.display.set_mode(
        (cfg.game.screen.width +
         cfg.game.screen.side_panel,
         cfg.game.screen.height))
    ...
    cursor_turret = pg.image.load(
        cfg.game.turret.cursor_turret).convert_alpha()
...
def display_data(
    ...
    pg.draw.rect(
        ...
        (cfg.game.screen.width,
         ...
         cfg.game.screen.side_panel,
         cfg.game.screen.height))
    pg.draw.rect(screen, "grey0", (cfg.game.screen.width,
                 0, cfg.game.screen.side_panel, 400), 2)
